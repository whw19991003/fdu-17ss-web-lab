...
<body>
    ...
    <main class="container">
          ...
          <div class="panel-body">
            <form action="Lab10.php" method="get" class="form-horizontal">
              ...
              <select name="continent" class="form-control">
				...
				$mysql = "SELECT ContinentCode,ContinentName FROM continents";
              ...
              <select name="country" class="form-control">
				...
				$mysql = "SELECT CountryName,ISO FROM countries";
				$result = $con->query($mysql);
				while($row = $result->fetch_assoc()) {
		...
		<ul class="caption-style-2">
            ...
            */ 
			$mysql = "SELECT ImageID, Title, Description, CountryCodeISO, ContinentCode, Path FROM imagedetails";
			$result = $con->query($mysql);
