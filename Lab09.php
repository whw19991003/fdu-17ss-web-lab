...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
			  ...
			  global $countries;
			  $x=array($countries["CA"],$countries["DE"],$countries["GR"],$countries["IT"],$countries["GB"],$countries["US"]);
			  foreach($x as $value)
			  {
				  print '<a href="list.php?country=$value" role="button" class="btn btn-default">'.$value."</a>";
			  }
